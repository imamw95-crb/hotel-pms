...
class DummyDataSeeder extends Seeder
{
    public function run()
    {
        ...
        if (Room::count() == 0) {
            ...
            $rooms = [
                // Lantai 1
                ['0101', 'STD', 500000, 2, 600000],
                ['0102', 'STD', 500000, 2, 600000],
                ['0103', 'DLX', 750000, 2, 900000],
                ['0105', 'DLX', 750000, 2, 900000],
                ['0106', 'DLX', 750000, 2, 900000],
                ['0107', 'STE', 1200000, 3, 1440000],
                ['0108', 'STE', 1200000, 3, 1440000],
                ['0109', 'STD', 500000, 2, 600000],
                ['0110', 'STD', 500000, 2, 600000],
                ['0111', 'DLX', 750000, 2, 900000],
                ['0112', 'DLX', 750000, 2, 900000],
                // Lantai 2
                ['0201', 'STD', 500000, 2, 600000],
                ['0202', 'STD', 500000, 2, 600000],
                ['0203', 'DLX', 750000, 2, 900000],
                ['0205', 'DLX', 750000, 2, 900000],
                ['0206', 'STE', 1200000, 3, 1440000],
                ['0207', 'STE', 1200000, 3, 1440000],
                ['0208', 'STD', 500000, 2, 600000],
                ['0209', 'STD', 500000, 2, 600000],
                ['0210', 'DLX', 750000, 2, 900000],
                ['0211', 'DLX', 750000, 2, 900000],
                // Lantai 3
                ['0301', 'STD', 500000, 2, 600000],
                ['0302', 'STD', 500000, 2, 600000],
                ['0303', 'DLX', 750000, 2, 900000],
                ['0305', 'DLX', 750000, 2, 900000],
                ['0306', 'STE', 1200000, 3, 1440000],
                ['0307', 'STE', 1200000, 3, 1440000],
                ['0308', 'STD', 500000, 2, 600000],
                ['0309', 'DLX', 750000, 2, 900000],
                ['0310', 'DLX', 750000, 2, 900000],
                ['0311', 'STE', 1200000, 3, 1440000],
            ];
