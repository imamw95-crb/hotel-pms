...
class DashboardController extends Controller
{
    ...
    public function adminDashboard()
    {
        ...
        return view('admin.dashboard', compact('totalUsers', 'totalRooms', 'totalReservations', 'totalRevenue'));
    }
    ...
    public function frontOfficeDashboard()
    {
        ...
        return view('frontoffice.dashboard', compact('availableRooms', 'todayCheckins', 'todayCheckouts'));
    }
}
