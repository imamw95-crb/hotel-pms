...
class InvoiceController extends Controller
{
    ...
    public function publicShow($reservationNumber)
    {
        ...
        if ($signature && $reservation->invoice_signature) {
            ...
            // Jika signature auto-generated (baru dibuat karena sebelumnya null),
            // jangan tampilkan 'invalid' — anggap saja 'no_signature' karena
            // sig di URL berasal dari data lama yang sudah berubah.
            $signatureStatus = $isValid ? 'valid' : ($sigAutoGenerated ? 'no_signature' : 'invalid');
        }
