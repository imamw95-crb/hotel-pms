...
<div class="bg-white rounded-xl shadow-xl overflow-hidden">
    {{-- Info Box --}}
    <div class="bg-blue-50 border-b border-blue-200 p-5 flex items-start gap-3">
        <i class="fas fa-receipt text-blue-500 mt-0.5"></i>
        <div class="text-sm text-blue-700">
            <p><strong class="text-base">Other Revenue Baru</strong></p>
            <p class="mt-0.5">Catat pendapatan lain selain kamar dan resto (laundry, extra bed, mini bar, room service, dll).</p>
        </div>
    </div>

    <form method="POST" action="{{ route('service-charge.store') }}" id="serviceChargeForm" data-ajax="true" data-refresh="true">
        @csrf
        ...
        <div class="p-5 border-b border-gray-100">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="flex flex-col justify-end">
                    ...
                    <div class="text-2xl font-bold text-blue-700 bg-gray-50 rounded-lg px-4 py-2.5 text-right border border-gray-200" id="totalDisplay">
        ...
        <div class="p-5 flex justify-between items-center bg-gray-50">
            <button type="button" onclick="Modal.close()" class="text-gray-500 hover:text-gray-700 font-medium px-4 py-2.5 rounded-lg hover:bg-gray-200 transition flex items-center gap-2">
                <i class="fas fa-arrow-left"></i> Batal
            </button>
            <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2.5 rounded-lg transition flex items-center gap-2 shadow-sm hover:shadow-md">
