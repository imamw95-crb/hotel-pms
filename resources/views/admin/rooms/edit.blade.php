        ...
        <div class="mb-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="price_weekday" value="{{ $room->price_weekday ?? old('price_weekday') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" min="0" placeholder="Senin–Jumat">
                    @error('price_weekday')
                        <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" name="price_weekend" value="{{ $room->price_weekend ?? old('price_weekend') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" min="0" placeholder="Sabtu–Minggu">
                    @error('price_weekend')
                        <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" name="price_per_night" value="{{ $room->price_per_night }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" required min="0" placeholder="Fallback harga">
