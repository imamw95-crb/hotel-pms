        ...
        <aside class="w-64 bg-blue-800 text-white flex-shrink-0 overflow-y-auto">
            ...
            <nav class="mt-6">
                ...
                @if(auth()->user()->isOwner() || auth()->user()->isAdmin() || auth()->user()->isUserManager())
                    ...
                    <a href="{{ route('reports.mhs-audit') }}" class="sidebar-item block py-2.5 px-4 rounded transition duration-200 {{ request()->routeIs('reports.mhs-audit') ? 'active' : 'hover:bg-blue-700' }}">
                        <i class="fas fa-microchip w-5 mr-2"></i> MHS Audit
                    </a>
        ...
        <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <header class="bg-white shadow-sm py-3 px-6 flex justify-between items-center">
                <div class="flex items-center">
                    ...
                    <span class="text-gray-800 font-semibold">@yield('header', 'Dashboard')</span>
                </div>
