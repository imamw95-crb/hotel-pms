...
<div class="bg-white rounded-lg shadow p-6 max-w-5xl mx-auto">
    ...
    <form method="POST" action="{{ route('booking.store') }}" data-ajax="true">
        ...
        <div class="flex justify-end space-x-2 mb-4">
            <button type="button" onclick="closeModal()" class="bg-gray-400 text-white px-4 py-2 rounded hover:bg-gray-500">Tutup</button>
...
{{-- Pass data to external JS via window variables --}}
<script>
